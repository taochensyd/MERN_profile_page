...
export const getProjects = (req, res) => {
    ...
    profileDataJSON.profile.projectsInfo.forEach((project) => { if (project.userId == req.params.id) { projectsInfoObj.push(project) } });
...
export const getEducations = (req, res) => {
    ...
    profileDataJSON.profile.education.forEach((education) => { if (education.userId == req.params.id) { educationObj.push(education) } }); //filter the education info by userId
...
export const getWorkExpreiences = (req, res) => {
    ...
    profileDataJSON.profile.workExperiences.forEach((workExpreience) => { if (workExpreience.userId == req.params.id) { workExperiencesObj.push(workExpreience) } }); //filter the work experiences info by userId
...
export const getSkills = (req, res) => {
    ...
    profileDataJSON.profile.skills.forEach((skill) => { if (skill.userId == req.params.id) { skillsObj.push(skill) } });    //filter the skills info by userId
...
export const getContactInfo = (req, res) => {
    ...
    profileDataJSON.profile.personalInfo.forEach((info) => { if (info.id == req.params.id) { personalInfoObj.push(info) } });   //filter the personal info by userId
